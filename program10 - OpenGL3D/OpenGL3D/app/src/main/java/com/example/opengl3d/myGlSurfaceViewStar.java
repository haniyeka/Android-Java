...
public class myGlSurfaceViewStar extends GLSurfaceView {

    myRendererStar myRender;

    public myGlSurfaceViewStar(Context context) {
        super(context);
        ...
        myRender = new myRendererStar(context);
