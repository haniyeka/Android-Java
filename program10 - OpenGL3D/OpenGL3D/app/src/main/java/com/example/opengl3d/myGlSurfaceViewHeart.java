...
public class myGlSurfaceViewHeart extends GLSurfaceView {

    myRendererHeart myRender;

    public myGlSurfaceViewHeart(Context context) {
        super(context);
        ...
        myRender = new myRendererHeart(context);
