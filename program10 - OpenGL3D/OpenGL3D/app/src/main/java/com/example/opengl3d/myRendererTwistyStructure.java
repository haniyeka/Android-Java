 ...
 *
 */
public class myRendererTwistyStructure implements GLSurfaceView.Renderer {

    private int mWidth;
    private int mHeight;
    private static String TAG = "myRenderer";
    public twistyStructure mTwistyStructure;
    ...
    //
    public myRendererTwistyStructure(Context context) {
    ...
    public void onSurfaceCreated(GL10 glUnused, EGLConfig config) {
        ...
        mTwistyStructure = new twistyStructure();
    ...
    public void onDrawFrame(GL10 glUnused) {
        ...
        mTwistyStructure.draw(mMVPMatrix);
