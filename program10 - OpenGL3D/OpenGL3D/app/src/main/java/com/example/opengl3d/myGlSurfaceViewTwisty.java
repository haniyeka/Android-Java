...
public class myGlSurfaceViewTwisty extends GLSurfaceView {

    myRendererTwistyStructure myRender;

    public myGlSurfaceViewTwisty(Context context) {
        super(context);
        ...
        myRender = new myRendererTwistyStructure(context);
